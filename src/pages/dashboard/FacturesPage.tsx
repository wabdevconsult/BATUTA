...
const FacturesPage = () => {
  ...
  const handleDelete = (id) => {
    ...
    setSuccess(`Facture ${id} supprimée avec succès`);
              ...
              {filteredFactures.map((facture) => (
                <tr key={facture.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusBadgeClass(facture.statut)}`}>
