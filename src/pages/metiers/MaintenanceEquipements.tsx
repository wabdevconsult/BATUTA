...
const MaintenanceEquipements = () => {
  const features = [
    {
      icon: Wrench,
      title: "Maintenance Préventive",
      description: "Planification et suivi des maintenances préventives de tous vos équipements."
    },
    {
      icon: Calendar,
      title: "Planning Maintenance",
      description: "Organisation optimisée des interventions selon les cycles de maintenance."
    },
    {
      icon: FileText,
    ...
    {
      icon: MapPin,
      title: "Localisation Équipements",
      description: "Géolocalisation et cartographie de tous vos équipements."
    },
    {
      icon: Users,
      title: "Équipes Techniques",
      description: "Gestion des techniciens de maintenance et leurs compétences."
    },
    {
      icon: BarChart3,
      title: "Suivi Performance",
      description: "Analyse des performances et historique des pannes équipements."
    }
  ];
  ...
  const testimonial = {
    ...
    role: "Responsable Maintenance - 15 ans d'expérience",
    content: "BATUTA nous a permis de réduire de 40% les pannes grâce à la maintenance préventive. La traçabilité des interventions est parfaite !",
    rating: 5
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                CRM spécialisé <span className="bg-gradient-to-r from-gray-600 to-blue-600 bg-clip-text text-transparent">maintenance équipements</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Optimisez la maintenance de vos équipements avec notre solution complète : 
                planning préventif, suivi des performances, gestion des pannes et traçabilité complète.
              </p>
            ...
            <div className="relative">
              <div className="bg-white rounded-xl shadow-2xl p-8">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">Tableau de Bord Maintenance</h3>
                </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">85% équipements opérationnels</div>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">12 maintenances planifiées</div>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-orange-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-gray-900">3 alertes en cours</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Fonctionnalités maintenance équipements
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Des outils spécialement conçus pour optimiser la maintenance de vos équipements
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
                Tous vos services de maintenance
              </h2>
              <p className="text-gray-600 mb-8 leading-relaxed">
                BATUTA couvre tous les aspects de la maintenance d'équipements, 
                de la prévention à la réparation d'urgence.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-blue-50 rounded-xl p-8">
              ...
              <p className="text-gray-600">d'augmentation de la durée de vie des équipements</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-gray-600 to-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-100 mb-8 max-w-2xl mx-auto">
            Rejoignez les professionnels qui ont choisi BATUTA pour leur maintenance d'équipements
          </p>
...
export default MaintenanceEquipements;